...
class BaseCrawler(object):
    ...
    Crawlers should implement dump method of this class
    """
    ...
    def dump(self, filename, add_links=False, verbose=False):
        ...
        :param filename: file, where dump will be saved
        :param add_links: if True website link will be added to dump
